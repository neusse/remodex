...
| `model`         | string  | No       | `inherit`             | Model to use: `fast`, `inherit`, or a specific model ID. See [model configuration](https://cursor.com/docs/subagents.md#model-configuration). |
...
| A specific model ID | Uses the exact model you specify, such as `claude-4-sonnet` or `gpt-5-mini`. See the [models reference](https://cursor.com/docs/models-and-pricing.md) for available IDs. |
