...
public struct CodeCommentDirectiveFinding: Identifiable, Equatable, Sendable {
...
public struct CodeCommentDirectiveContent: Equatable, Sendable {
    public let findings: [CodeCommentDirectiveFinding]
    public let fallbackText: String

    public init(findings: [CodeCommentDirectiveFinding], fallbackText: String) {
...
public enum CodeCommentDirectiveParser {
    ...
    private static let titlePriorityRegex = try? NSRegularExpression(
        pattern: #"^\s*\[(P\d+)\]\s*"#,
        options: [.caseInsensitive]
    )

    public static func parse(from rawText: String) -> CodeCommentDirectiveContent {
    ...
    private static func strippingPriorityPrefix(from title: String) -> String {
        ...
        let stripped = titlePriorityRegex.stringByReplacingMatches(
            in: title,
            range: fullRange,
            withTemplate: ""
        )
