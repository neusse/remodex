...
const MISSION_EVENTS: Record<string, { suffixes: string[]; screen?: string; oncePerDay?: boolean }> = {
  ...
  searches_expanded: { suffixes: ["searches"], screen: "conversation" },
  repo_diff_reviewed: { suffixes: ["repo-diff-review"], screen: "git" },
  mobile_pr_draft_opened: { suffixes: ["mobile-pr-draft"], screen: "git" },
  project_thread_started: { suffixes: ["project-thread"], screen: "sidebar" },
  user_bubble_color_changed: { suffixes: ["user-bubble"], screen: "settings" },
  onboarding_completed: { suffixes: ["onboarding"], screen: "onboarding" },
  plan_rendering_checked: { suffixes: ["plan-rendering"], screen: "conversation" },
  ...
  turn_steered: { suffixes: ["steering"], screen: "composer" },
  ...
  terminal_opened: { suffixes: ["terminal-open"], screen: "terminal" },
  terminal_profile_saved: { suffixes: ["terminal-profile"], screen: "terminal" },
  terminal_connect_started: { suffixes: ["terminal-connect"], screen: "terminal" },
